...
---
This project was developed during my Data Science internship at Oasis Infobyte. The goal was to build a machine learning model to estimate the market value of vehicles based on technical specifications and historical price data.

---
📌 Project Objective
To create a robust regression model that accurately predicts car prices by analyzing features such as fuel type, engine horsepower, and brand specifications, assisting in objective market valuation.
